...
def plants_list():
    ...
    plants_collection = mongo.db.plants.find()
...
def create():
    ...
    if request.method == 'POST':
        ...
        plant_var = new_plant['name']

        return redirect(url_for('detail', plant_id=plant_var))
...
def edit(plant_id):
    ...
    if request.method == 'POST':
        ...
        # passed-in _id.
        plant_to_show = mongo.db.plants.find_one({'plant_id': plant_id})
...
def delete(plant_id):
    ...
    # id.
    mongo.db.plants.delete_one({'plant_id': plant_id})
